...
<head>
    ...
    <style>
		...
		nav {
    		margin: 20px 0;
    		display: flex;
    		justify-content: space-between; /* Spread items between start and end */
    		align-items: center;
		}
        ...
        nav .logout {
    		background-color: #ff0000; /* Background for the logout link */
    		padding: 12px 18px; /* Padding to create the rectangular effect */
    		border-radius: 5px; /* Optional: Rounded corners */
    		font-size: 0.9rem; /* Slightly smaller font size for logout */
    		font-weight: bold;
    		text-align: center;
    		float: right; /* Push to the right */
    		margin-left: auto; /* Ensure it's separated from other links */
		}

		nav .logout:hover {
    		background-color: #ff6b6b; /* Hover effect for logout */
		}
...
<header>
   ...
   <nav>
        ...
        <a href="Login.jsp" class="logout">Logout</a> <!-- Logout with rectangle background -->
    </nav>
</header>
